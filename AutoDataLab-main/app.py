            ...
            st.markdown("""
                <div style='background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); 
                    ...
                    <div style='color: white; text-align: center;'>
                        <div style='font-size: 2.5rem; margin-bottom: 0.5rem; font-weight: bold;'>[USER]</div>
                        <div style='font-size: 1.1rem; font-weight: 600; margin-bottom: 0.3rem;'>{}</div>
...
def main():
    ...
    # Check if profile editing page should be shown
    ...
    # Check if user management page should be shown
